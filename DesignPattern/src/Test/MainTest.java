...
public class MainTest {
	...
	public void testBuilder(){
		...
		veg.showItems();
		System.out.println("cost"+veg.getCost());
		System.out.println("-----------");
		
		Meal meat = mealBuilder.meatMeal();
		meat.showItems();
		System.out.println("cost"+meat.getCost());
	}
	@Test
	public void testAdapter(){
		AudioPlayer audioPlayer = new AudioPlayer();
		audioPlayer.play("mp4", "Õ½ÀÇ.mp4");
		audioPlayer.play("dada", "dadsd");
	}
